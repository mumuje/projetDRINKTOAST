        ...
        <div class="container mt-4">
            ...
            <main>
                ...
                <div class="wrap animate pop">
                    ...
                    <div class="text">
                        <p><img class="inset" src="img/bleu.png" alt="" />Bienvenue dans le délicieux défi de la Carte
                            Bleue, un jeu palpitant de "devine le nombre" qui va pimenter votre soirée !</p></p>Le joueur qui
                            brandit fièrement la carte bleue, a la mission de choisir un ou plusieurs chiffres entre 0
                            et 9.</p>
                        <p>Une fois que le choix est fait, la tension monte, et c'est le moment de la révélation ! Le
                        ...
                        <p>Imaginez ceci : Notre valeureux joueur A sélectionne les chiffres 1, 5, 8, et 9 avec un
                        ...
                        <p>Alors, que le jeu commence, que les rires résonnent, et que la Carte Bleue ajoute une touche
                ...
                <div class="wrapJaune animate pop">
                    <div class="overlayJaune">
                        <div class="overlay-contentJaune animateJaune slide-left delay-2">
                            ...
                            <p class="animateJaune slide-left pop delay-5" style="color: white; margin-bottom: 2.5rem;">
                    ...
                    <div class="textJaune">
                        <p><img class="insetJaune" src="img/jaune.png" alt="" />Bienvenue dans l'électrisant défi de la
                            Carte Jaune, un jeu enivrant de questions aléatoires qui va ajouter une pincée de mystère à
                            votre soirée ! </p>
                        <p>Le joueur chanceux qui brandit fièrement la carte jaune a la mission de choisir un joueur et
                            de lui lancer une question surprise, une question pleine d'incertitude qui piquera sa
                            curiosité.</p>
                        <p>Une fois que la question est posée, la tension monte, et voilà le moment crucial ! Le joueur
                        ...
                        <p>Imaginez ceci : Notre joueur A, espiègle, pointe du doigt le courageux joueur B pour
                        ...
                        <p>Alors que les votes fusent, que les rires résonnent, la Carte injecte un zeste d'intrigue et
                ...
                <div class="wrapRouge animate pop">
                    <div class="overlayRouge">
                        <div class="overlay-contentRouge animateRouge slide-left delay-2">
                            ...
                            <p class="animateRouge slide-left pop delay-5" style="color: white; margin-bottom: 2.5rem;">
                    ...
                    <div class="textRouge">
                        <p><img class="insetRouge" src="img/rouge.png" alt="" />Bienvenue dans l'énergique défi de la
                            Carte Rouge, une explosion d'actions qui va propulser votre soirée vers des sommets
                            d'amusement !</p>
                        <p>Le joueur audacieux qui brandit fièrement la carte rouge a une mission excitante : choisir un
                        ...
                        <p>Une fois l'action dévoilée, la tension monte, et voilà le moment crucial ! Le joueur élu
                        ...
                        <p>Imaginez ceci : Notre joueur A, espiègle, désigne le courageux joueur B pour affronter le
                ...
                <div class="wrapVerte animate pop">
                    <div class="overlayVerte">
                        <div class="overlay-contentVerte animateVerte slide-left delay-2">
                            ...
                            <p class="animateVerte slide-left pop delay-5" style="color: white; margin-bottom: 2.5rem;">
                    ...
                    <div class="textVerte">
                        <p><img class="insetVerte" src="img/verte.png" alt="" />Bienvenue dans le fascinant défi de la
                            Carte Verte, une aventure énigmatique qui va ajouter une touche de mystère à votre soirée !
                        </p>
                        <p>Le joueur rusé qui brandit fièrement la carte Verte a pour mission de choisir un complice
                            parmi les participants. Ce joueur intrépide se voit confier une énigme à résoudre, un défi
                            intellectuel captivant.</p>
                        <p>Une fois l'énigme dévoilée, l'excitation monte, et voilà le moment crucial ! Le joueur élu
                        ...
                        <p>Imaginez ceci : Notre joueur A, malicieux, désigne le courageux joueur B pour relever le
                        ...
                        <p>Les 45 secondes s'écoulent, et voilà le dénouement ! La Carte Verte réserve une surprise
                            supplémentaire : tous les participants votent sur la justesse ou non de
                            la réponse du joueur B.</p>
                        <p> Les rires éclatent, les votes retentissent, la Carte Verte insuffle
                ...
                <div class="wrapMulticolore animate pop">
                    <div class="overlayMulticolore">
                        <div class="overlay-contentMulticolore animateMulticolore slide-left delay-2">
                            ...
                            <p class="animateMulticolore slide-left pop delay-5"
                    ...
                    <div class="textMulticolore">
                        <p><img class="insetMulticolore" src="img/multicolor.png" alt="" />Bienvenue dans l'intriguant
                            défi de la Carte Multicolore, un tourbillon mystérieux qui va teinter votre soirée d'une
                            aura magique !</p>
                        <p>Le joueur astucieux qui arbore fièrement la carte Multicolore détient un pouvoir exceptionnel
                            : faire boire tous les participants, à l'exception de lui-même.</p>
                        <p>Le suspense atteint son apogée, et voilà le dénouement ! La Carte Multicolore réserve une
                ...
                <div class="wrapViolette animate pop">
                    <div class="overlayViolette">
                        <div class="overlay-contentViolette animateViolette slide-left delay-2">
                            ...
                            <p class="animateViolette slide-left pop delay-5"
                                style="color: white; margin-bottom: 2.5rem;">
                    ...
                    <div class="textViolette">
                        <p><img class="insetViolette" src="img/violette.png" alt="" />Bienvenue dans le captivant défi
                            de la Carte Violette, un éclat mystérieux qui va teinter votre soirée d'une aura envoûtante
                            !</p>
                        <p>Le joueur rusé qui arbore fièrement la carte Violette détient un pouvoir extraordinaire :
                            choisir deux joueurs (peut même se choisir lui-même) pour s'affronter dans un mini-jeu 1v1
                            palpitant.</p>
                        <p>Le suspense atteint son apogée, et voilà le dénouement ! La Carte Violette propose trois
                        ...
                        <p>Si le joueur B ne trouve pas le bon chiffre, le nombre de possibilités diminue
                        ...
                        <p>Le suspense monte, et c'est là que ça devient intéressant ! À chaque tour, le nombre de
                        ...
                        </p>Alors que les rires fusent et la compétition s'installe. La
                ...
                <p><strong>Écoutez bien !</strong> Vous avez le pouvoir de déployer deux cartes communes à chaque tour ou une carte rare par tour ! Le plaisir avant tout !!!</p>                </div>
