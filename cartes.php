        ...
        <div class="container mt-4">
            ...
            <main>
                ...
                <div class="wrap animate pop">
                    ...
                    <div class="text">
                        <p class="special-text2"><img class="inset" src="img/bleu.png" alt="" />Bienvenue dans le délicieux défi de la Carte
                            Bleue, un jeu palpitant de "devine le nombre" qui va pimenter votre soirée !</p><p class="special-text2">Le joueur qui
                            brandit fièrement la carte bleue, a la mission de choisir un ou plusieurs chiffres entre 0
                            et 9.</p>
                        <p class="special-text2">Une fois que le choix est fait, la tension monte, et c'est le moment de la révélation ! Le
                        ...
                        <p class="special-text2">Imaginez ceci : Notre valeureux joueur A sélectionne les chiffres 1, 5, 8, et 9 avec un
                        ...
                        <p class="special-text2">Alors, que le jeu commence, que les rires résonnent, et que la Carte Bleue ajoute une touche
                ...
                <div class="wrapJaune animate pop">
                    ...
                    <div class="textJaune">
                        <p class="special-text2"><img class="insetJaune" src="img/jaune.png" alt="" />Bienvenue dans l'électrisant défi de la
                            Carte Jaune, un jeu enivrant de questions aléatoires qui va ajouter une pincée de mystère à
                            votre soirée ! </p>
                        <p class="special-text2">Le joueur chanceux qui brandit fièrement la carte jaune a la mission de choisir un joueur et
                            de lui lancer une question surprise, une question pleine d'incertitude qui piquera sa
                            curiosité.</p>
                        <p class="special-text2">Une fois que la question est posée, la tension monte, et voilà le moment crucial ! Le joueur
                        ...
                        <p class="special-text2">Imaginez ceci : Notre joueur A, espiègle, pointe du doigt le courageux joueur B pour
                        ...
                        <p class="special-text2">Alors que les votes fusent, que les rires résonnent, la Carte injecte un zeste d'intrigue et
                ...
                <div class="wrapRouge animate pop">
                    ...
                    <div class="textRouge">
                        <p class="special-text2"><img class="insetRouge" src="img/rouge.png" alt="" />Bienvenue dans l'énergique défi de la
                            Carte Rouge, une explosion d'actions qui va propulser votre soirée vers des sommets
                            d'amusement !</p>
                        <p class="special-text2">Le joueur audacieux qui brandit fièrement la carte rouge a une mission excitante : choisir un
                        ...
                        <p class="special-text2">Une fois l'action dévoilée, la tension monte, et voilà le moment crucial ! Le joueur élu
                        ...
                        <p class="special-text2">Imaginez ceci : Notre joueur A, espiègle, désigne le courageux joueur B pour affronter le
                ...
                <div class="wrapVerte animate pop">
                    ...
                    <div class="textVerte">
                        <p class="special-text2"><img class="insetVerte" src="img/verte.png" alt="" />Bienvenue dans le fascinant défi de la
                            Carte Verte, une aventure énigmatique qui va ajouter une touche de mystère à votre soirée !
                        </p>
                        <p class="special-text2">Le joueur rusé qui brandit fièrement la carte Verte a pour mission de choisir un complice
                            parmi les participants. Ce joueur intrépide se voit confier une énigme à résoudre, un défi
                            intellectuel captivant.</p>
                        <p class="special-text2">Une fois l'énigme dévoilée, l'excitation monte, et voilà le moment crucial ! Le joueur élu
                        ...
                        <p class="special-text2">Imaginez ceci : Notre joueur A, malicieux, désigne le courageux joueur B pour relever le
                        ...
                        <p class="special-text2">Les 45 secondes s'écoulent, et voilà le dénouement ! La Carte Verte réserve une surprise
                ...
                <div class="wrapMulticolore animate pop">
                    ...
                    <div class="textMulticolore">
                        <p class="special-text2"><img class="insetMulticolore" src="img/multicolor.png" alt="" />Bienvenue dans l'intriguant
                            ...
                            aura magique !</p>
                        <p class="special-text2">Le joueur astucieux qui arbore fièrement la carte Multicolore détient un pouvoir exceptionnel
                            : faire boire tous les participants, à l'exception de lui-même.</p>
                        <p class="special-text2">Le suspense atteint son apogée, et voilà le dénouement ! La Carte Multicolore réserve une
                ...
                <div class="wrapViolette animate pop">
                    ...
                    <div class="textViolette">
                        <p class="special-text2"><img class="insetViolette" src="img/violette.png" alt="" />Bienvenue dans le captivant défi
                            de la Carte Violette, un éclat mystérieux qui va teinter votre soirée d'une aura envoûtante
                            !</p>
                        <p class="special-text2">Le joueur rusé qui arbore fièrement la carte Violette détient un pouvoir extraordinaire :
                            choisir deux joueurs (peut même se choisir lui-même) pour s'affronter dans un mini-jeu 1v1
                            palpitant.</p>
                        <p class="special-text2">Le suspense atteint son apogée, et voilà le dénouement ! La Carte Violette propose trois
                        ...
                        <p class="special-text2">Si le joueur B ne trouve pas le bon chiffre, le nombre de possibilités diminue
                        ...
                        <p class="special-text2">Le suspense monte, et c'est là que ça devient intéressant ! À chaque tour, le nombre de
